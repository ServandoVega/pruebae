...
import com.example.pruebaexm.user.activity.MainActivity
...
class CreateRegisterFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mActivity?.supportActionBar?.title = getString(R.string.register_new)
    ...
    private fun permissionCamara() {
        ...
        externalPermissionRequest.launch(
            arrayOf(
                Manifest.permission.READ_EXTERNAL_STORAGE,
                Manifest.permission.WRITE_EXTERNAL_STORAGE
            )
    ...
    private fun handleCameraImage() {
        ...
        vBind.imgCard.visibility = View.VISIBLE
